...
type HttpCashe struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PathId int64  `protobuf:"varint,1,opt,name=path_id,json=pathId,proto3" json:"path_id,omitempty"`
	Data   []byte `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
}

func (x *HttpCashe) Reset() {
	*x = HttpCashe{}
...
func (x *HttpCashe) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HttpCashe) ProtoMessage() {}

func (x *HttpCashe) ProtoReflect() protoreflect.Message {
	mi := &file_cache_proto_msgTypes[0]
...
// Deprecated: Use HttpCashe.ProtoReflect.Descriptor instead.
func (*HttpCashe) Descriptor() ([]byte, []int) {
	return file_cache_proto_rawDescGZIP(), []int{0}
}

func (x *HttpCashe) GetPathId() int64 {
	if x != nil {
		return x.PathId
	}
	return 0
...
var file_cache_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x38, 0x0a, 0x09, 0x48, 0x74, 0x74, 0x70, 0x43, 0x61, 0x73,
	0x68, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x61, 0x74, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x06, 0x70, 0x61, 0x74, 0x68, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42,
	0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x76,
	0x65, 0x72, 0x61, 0x67, 0x65, 0x4e, 0x65, 0x74, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x61, 0x6e,
	0x64, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2f, 0x61, 0x6e, 0x64, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
...
var file_cache_proto_goTypes = []interface{}{
	(*HttpCashe)(nil), // 0: proto.HttpCashe
}
